...
| C5 | pending | | |
| C6 | MERGED | (this commit) | ADR-0042. FeatureSelector + sklearn-select (doorway) + torch-importance (input-gradient). torch.py DRAINED (91 D → 0). Flows 1 and 3 e2e; flow 2 refused by ADR-0040's per-role guard — ADR-0044 proposed, not implemented. Hash gate empty (17 docs). Suite 2637/109 pipeline+libs (main was 2554/109; skip count unchanged). |

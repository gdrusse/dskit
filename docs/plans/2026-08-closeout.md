...
| D1 | MERGED | (this branch) | selection-demo.json: VarianceThreshold on mid+noise, sweep LinearRegression vs Ridge, winner consumes `$select.features`. Flow 2 (space over selector knob + estimator) plans and runs via ADR-0044. Ledger 18. |

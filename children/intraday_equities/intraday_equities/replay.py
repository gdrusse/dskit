"""Developmental equity replay policies over existing production seams (ADR-0119).
...
``PaperExecutor``. Overlap/expiry is ADR-0119 **proposed**.
...
class FillPolicy:
    ...
    params : dict
        ...
        are the ADR-0119 proposed/ruled members; any other member

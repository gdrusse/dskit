...
row A18872. Round-1 architecture memo is the prior verdict, not a
...
- **`path.csv`:** repo-root and child, empty diff. Journal A18872 is
  `next_id = max+1` after A18871; README latest-10 slide only. Agents did
  not edit Path.

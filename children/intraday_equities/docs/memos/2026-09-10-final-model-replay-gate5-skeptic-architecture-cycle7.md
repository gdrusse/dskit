...
`140e387b2a49df3590d178b175960b2c0fe6871f` (A18881), method memo
...
journal A18881. Cycle-6 architecture memo is the prior verdict to
...
decision-log is 0 bytes). Journal `140e387` is A18881. Method memo
...
- **Trees:** README names `replay.py`; AGENTS/CLAUDE configs-line names
  ...
  reviewer may write).
- **Journal A18881:** follows A18880 (`next_id = max+1`); unique; README

...
Cycle-3 did not compose `ServeLoop`. Journal A18874 names that gap
...
A18874. Round-2 architecture memo is the prior verdict, not a finding to
rubber-stamp.

What I tried to accept and could not: (1) A18874 / module docstring /
...
This is the round-1/2 Critical. Cycle-3 did not claim to close it. A18874
...
the module docstring, node notes, ADR Consequences, and journal A18874
...
- Node notes still say "Trailing bars after evidence_end may fill
  ...
  is not a pin.
- A18874 documents the window in the journal ("evidence_end+2 UTC
...
- **Journal A18874:** `next_id = max + 1` after A18873; unique; README
  latest-10 dropped A18862 and added A18874 (display-only slide).

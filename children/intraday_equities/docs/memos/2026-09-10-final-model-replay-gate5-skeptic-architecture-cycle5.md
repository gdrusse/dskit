...
`5f49bfa2843d0970b60a6e1a15c51ae5f71ddf9c` (A18875), method memo `90ea3ce`
...
`configs/run-development-replay.json`; both child trees; journal A18875.
...
ADR-0117 Files only (Status stays proposed). Journal `5f49bfa` is A18875.
...
- **Trees:** README names `replay.py`; AGENTS/CLAUDE configs-line names
  ...
  reviewer may write).
- **Journal A18875:** follows A18874 (`next_id = max+1`); unique; README

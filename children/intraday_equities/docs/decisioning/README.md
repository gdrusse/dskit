...
| A18801 | execute | correct P17 RandomForest evidence claim | 2026-09-07T18:55:41+00:00 | A18800; configs/run-p17-randomforest-zoo.json | docs/memos/p15-temporal-fusion-model-zoo-results.md |  | Supersedes only A18800 wording: two completed RF folds are descriptive incomplete evidence, not statistical indistinguishability or equivalence; no paired comparison artifact or prespecified equivalence margin exists. P16 completed result is unchanged; no RF promotion or refit. |

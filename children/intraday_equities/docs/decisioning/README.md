...
| A18868 | research | Gate 3 cash-flow inventory and proposed ADR | 2026-09-10T13:06:32+00:00 | ADR-0114 Phase 3; final-model replay plan section 6; production compose state report inventory | docs/architecture/decision-log.md ADR-0117 |  | Mechanism proposal only; plan section 11 item 2 remains open; no code or config authored |
| A18869 | execute | Implement Gate 3 cash-flow and return mechanisms | 2026-09-10T15:06:05+00:00 | ADR-0117; Gate 3 kickoff | dskit/production/cashflows.py; compose.py; state.py; report.py; focused tests | git:codex/gate3-cashflows-f74aff8 | Mechanism-only replay declarations and generic TWR/MWR; no capital policy or same-timestamp decision ordering. |

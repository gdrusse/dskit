# P5 result: the 30 horizon-sweep walks under ADR-0067

Date: 2026-09-03. Rule: `docs/architecture/decision-log.md`, ADR-0067. Plan: `docs/plans/2026-09-horizon-search.md`, P5.
...
So of ADR-0067's two required halves:
...
Mean Clark-West t over the 20 folds, and the fraction of folds it rejected at 5%, for the group. It is reported because ADR-0067 says to report it — it is never the verdict.
...
- No cell can be declared a PASS: the pooled half is unrecoverable from what was saved. To settle these, re-run the affected configurations with the ADR-0067 artifact in place.

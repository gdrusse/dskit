...
SAMPLES = {
    ...
    "Attribution": records.Attribution(
        ...
        surprise=0.08,
        impact=Decimal("0.30"),
        opportunity=Decimal("1.20"),
        fees=Decimal("0.03"),
        shortfall=Decimal("1.53"),
        markouts={"60000": Decimal("0.02"), "300000": None},
        outcome_value=Decimal("0.70"),
        closing_value=Decimal("0.70"),
    ),
    "CalibrationReport": records.CalibrationReport(
        n=8,
        bins=10,
        ece=0.11,
        brier=0.243,
        ...
        baseline_brier=0.25,
        bss=0.028,
        dm={"t": 0.14, "p_value": 0.44},
    ),
    "ValuePoint": records.ValuePoint(
        at_ms=MS,
        realised=Decimal("-1"),
        unrealised=Decimal("0"),
        external=Decimal("5000"),
        nav=Decimal("1200"),
        cumulative=Decimal("-1"),
        drawdown=Decimal("-1"),
    ),
    "Divergence": records.Divergence(
        seq=7,
    ...
    "ParityReport": records.ParityReport(
        compared=12,
        divergences=(),

...
* **The event catalogue** ``EVENT_SCHEMA_VERSION``, ``EVENT_CATEGORIES``,
  ...
  (ADR-0118), which say what one decision event records, which two of its
...
MONEY_FIELDS = (
    ...
    "ask",
    "mid",
    # ADR-0118's portfolio/capital catalogue category (§6): every field
...
# ---------------------------------------------------------------------------
# The versioned event catalogue (ADR-0118; ADR-0114 "Phase 6")
# ---------------------------------------------------------------------------
...
METRIC_LABEL_VALUES = {
    ...
    # than as the mis-declaration it is (ADR-0118).
    ...
    # ADR-0118's safe aggregates: the catalogue readings of
